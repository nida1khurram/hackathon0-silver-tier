...
SELECTORS = {
    ...
    "qr_code_fallback": 'div[data-testid="qrcode"], div[role="img"][aria-label*="QR"]',
    "phone_disconnected": 'div[data-testid="alert-phone"], div[data-testid="alert-banner"]',
    ...
    "chat_row": 'div[data-testid="cell-frame-container"], div[role="row"], div[role="listitem"]',
...
# Combined selector: any of these means chats are loaded / login succeeded / QR shown
...
class WhatsAppWatcher(BaseWatcher):
    ...
    async def _launch_browser(self) -> None:
        ...
        # Use a real Chrome user-agent to avoid browser detection
    ...
    async def _navigate_to_whatsapp(self) -> None:
        ...
        for selector in [
            ...
            try:
                ...
                if element:
                    self.logger.debug("Found element: %s", selector)
                    return
            except Exception:
                continue
        
        # If nothing found, take a screenshot for debugging
        self.logger.warning("No expected elements found. Page may still be loading.")
